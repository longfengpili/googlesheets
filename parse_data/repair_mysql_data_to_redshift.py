...
@LastEditTime: 2019-07-03 10:54:54
@coding: 
#!/usr/bin/env python
# -*- coding:utf-8 -*-
...
class RepairMysqlDataToRedshift(object):
    def __init__(self, mysqlhost, mysqluser, mysqlpassword, mysqldatabase, redshift_host, redshift_user, redshift_password, redshift_database, orignal_columns):
