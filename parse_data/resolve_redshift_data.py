...
@LastEditTime: 2019-07-03 14:15:51
@coding: 
#!/usr/bin/env python
# -*- coding:utf-8 -*-
...
class ResolveRedshiftData(object):
    ...
    def resolve_redshift_main(self, repair_tablename, resolve_tablename, id_min=None, id_max=None):
        '''
        @description: 处理格式并拆解
        @param {type} 
